...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "department_budgets_budget_id_department_id_key",
        "department_budgets",
        type_="unique",
    )
    ...
    op.drop_constraint(
        "recognition_reactions_recognition_id_user_id_reaction_type_key",
        "recognition_reactions",
        type_="unique",
    )
    op.add_column(
        "redemptions", sa.Column("item_type", sa.String(length=20), nullable=False)
    )
    op.add_column("redemptions", sa.Column("item_id", models.GUID(), nullable=True))
    op.add_column(
        "redemptions", sa.Column("item_name", sa.String(length=255), nullable=False)
    )
    ...
    op.add_column(
        "redemptions", sa.Column("otp_code", sa.String(length=6), nullable=True)
    )
    op.add_column(
        "redemptions",
    ...
    op.add_column(
        "redemptions", sa.Column("delivery_details", models.JSONType(), nullable=True)
    )
    op.add_column(
        "redemptions",
    ...
    op.alter_column("redemptions", "voucher_id", existing_type=sa.UUID(), nullable=True)
    ...
    op.create_foreign_key(
        None, "redemptions", "users", ["user_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "redemptions", "vouchers", ["voucher_id"], ["id"], ondelete="SET NULL"
    )
    ...
    op.drop_constraint(
        "tenant_vouchers_tenant_id_voucher_id_key", "tenant_vouchers", type_="unique"
    )
    op.add_column(
        "tenants", sa.Column("logo_url", sa.String(length=500), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("favicon_url", sa.String(length=500), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("theme_config", models.JSONType(), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("domain_whitelist", models.JSONType(), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("auth_method", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("currency_label", sa.String(length=100), nullable=True)
    )
    op.add_column(
        "tenants",
    ...
    op.add_column(
        "tenants",
        sa.Column(
            "auto_refill_threshold", sa.Numeric(precision=5, scale=2), nullable=True
        ),
    )
    op.add_column("tenants", sa.Column("award_tiers", models.JSONType(), nullable=True))
    op.add_column(
        "tenants", sa.Column("peer_to_peer_enabled", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "tenants", sa.Column("expiry_policy", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "users",
        sa.Column(
            "org_role", sa.String(length=50), nullable=False, server_default="employee"
        ),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        "idx_wallet_ledger_wallet_id", "wallet_ledger", ["wallet_id"], unique=False
    )
    op.create_index(
        "idx_wallet_ledger_created_at", "wallet_ledger", ["created_at"], unique=False
    )
    ...
    op.create_unique_constraint(
        "tenant_vouchers_tenant_id_voucher_id_key",
        "tenant_vouchers",
    ...
    op.add_column(
        "redemptions",
        sa.Column(
            "voucher_pin", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
    )
    op.drop_constraint(None, "redemptions", type_="foreignkey")
    op.drop_constraint(None, "redemptions", type_="foreignkey")
    op.create_foreign_key(
        "redemptions_user_id_fkey", "redemptions", "users", ["user_id"], ["id"]
    )
    op.create_foreign_key(
        "redemptions_voucher_id_fkey", "redemptions", "vouchers", ["voucher_id"], ["id"]
    )
    op.alter_column(
        "redemptions", "voucher_id", existing_type=sa.UUID(), nullable=False
    )
    op.alter_column(
        "redemptions",
        "status",
    ...
    op.create_unique_constraint(
        "recognition_reactions_recognition_id_user_id_reaction_type_key",
        "recognition_reactions",
        ["recognition_id", "user_id", "reaction_type"],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_feed_tenant_created",
        "feed",
        ["tenant_id", sa.text("created_at DESC")],
        unique=False,
    )
    op.create_unique_constraint(
        "departments_tenant_id_name_key", "departments", ["tenant_id", "name"]
    )
    op.add_column(
        "department_budgets",
        sa.Column(
            "remaining_points",
            sa.NUMERIC(precision=15, scale=2),
            sa.Computed("(allocated_points - spent_points)", persisted=True),
            autoincrement=False,
            nullable=True,
        ),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "remaining_points",
            sa.NUMERIC(precision=15, scale=2),
            sa.Computed("(total_points - allocated_points)", persisted=True),
            autoincrement=False,
            nullable=True,
        ),
    )
